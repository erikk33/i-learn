...
--
-- Host: localhost
-- Generation Time: Mar 11, 2022 at 12:25 AM
...
--
-- Database: `toko playstation`
--

-- --------------------------------------------------------

--
-- Table structure for table `harga_playstation`
--

CREATE TABLE `harga_playstation` (
  `id` int(11) NOT NULL,
  `harga_ps1` varchar(100) DEFAULT NULL,
  `harga_ps2` varchar(98) NOT NULL,
  `harga_ps3` varchar(93) DEFAULT NULL,
  `id_hdd` int(11) NOT NULL,
  `nama` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `harga_playstation`
--

INSERT INTO `harga_playstation` (`id`, `harga_ps1`, `harga_ps2`, `harga_ps3`, `id_hdd`, `nama`) VALUES
(1, 'beli 25', 'tidak beli', 'beli 50 ', 1012902, NULL),
(2, 'beli 290', 'tidak beli', 'tidak beli', 10902, NULL),
(3, 'malas beli', 'tidak beli', 'beli 2 ', 1012902, 'carinaaa'),
(4, 'beli 1 ', 'beli 190', 'tidak beli', 1023902, 'rezaysd');
...
CREATE TABLE `hdd` (
  ...
  `hdd_sata_gen2` varchar(80) NOT NULL,
  `hdd_sata_gen3` varchar(97) DEFAULT NULL,
...
INSERT INTO `hdd` (`id`, `nama`, `hdd_sata_gen2`, `hdd_sata_gen3`, `no_tlp`, `alamat`) VALUES
(10902, 'amanda caroline', 'beli satu buah hdd sata gen 2', 'tidak beli', '085763920', 'denpasar barat'),
(1012902, 'Maha Esa', 'beli satu buah hdd sata gen 2', 'tidak beli', '085763920', 'denpasar barat'),
(1023902, 'yukinoshita yukino', 'beli satu buah hdd sata gen 2', 'tidak beli', '085763920', 'denpasar timur'),
(1097802, 'miku nakano', 'beli tiga buah hdd sata gen 2', 'tidak beli', '085763920', 'denpasar selatan'),
(1099902, 'tsunade', 'beli satu buah hdd sata gen 2', 'tidak beli', '085763920', 'japan');
...
--
-- Indexes for table `harga_playstation`
--
ALTER TABLE `harga_playstation`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `harga_playstation`
--
ALTER TABLE `harga_playstation`
...
--
ALTER TABLE `hdd`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1090245817;
...
--
-- Constraints for table `harga_playstation`
--
ALTER TABLE `harga_playstation`
  ADD CONSTRAINT `fk_hdd` FOREIGN KEY (`id_hdd`) REFERENCES `hdd` (`id`);
